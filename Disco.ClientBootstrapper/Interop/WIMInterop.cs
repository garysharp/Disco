...
namespace Disco.ClientBootstrapper.Interop.WIMInterop
{
    ...
    WindowsImageContainer : IDisposable
    {
        ...
        NativeMethods
        {
            ...
            //WIMMountImageHandle(
            //    IntPtr hImage,
            //    [MarshalAs(UnmanagedType.LPWStr)] string pszMountPath,
            //    uint dwMountFlags
            //    );
            /////<summary>
            /////Mounts an image in a .wim file to the specified directory.
            ...
            //static
            //void
            //MountImageHandle(string mountPath, )
            //{
            //    bool status = false;
            //    int rc;
            ...
            static
            void
            MountImage(string mountPath, string windowsImageFileName, int imageIndex, string temporaryPath)
            {
                bool status = false;
                int rc;
